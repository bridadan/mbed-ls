...
class MbedLsToolsBase:
    ...
    def list_mbeds_ext(self, target_ids=[]):
        ...
        mbeds = self.list_mbeds(target_ids=target_ids)
    ...
    def list_platforms(self, target_ids=[]):
    ...
    def list_platforms_ext(self, target_ids=[]):
    ...
    def list_mbeds_by_targetid(self, target_ids=[]):
        ...
        """
        result = {}
        mbed_list = self.list_mbeds_ext(target_ids=target_ids)
    ...
    def get_string(self, border=False, header=True, target_ids=[], padding_width=1, sortby='platform_name'):
